...
AUTO_NL: dict[str, str] = {
    ...
    "recipes_missing_tags.action.cancel": "Annuleren",
    "recipes_missing_tags.aria.edit_group": "Tags toevoegen voor {group_name}",
    "recipes_missing_tags.aria.save": "Tags opslaan",
    "recipes_missing_tags.aria.cancel": "Tags bewerken annuleren",
    ...
    "recipes_missing_tags.hint": "Klik op een ontbrekende taggroep om tags voor dat recept te kiezen en sla daarna op of annuleer.",
