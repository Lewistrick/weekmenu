...
- **Inventory** — Keep track of what you have at home, per ingredient and unit. When a grocery list is generated, items your inventory fully covers go straight to "already have" and their amount is subtracted from the inventory; move them back to a list and the amount returns. Marking an item "already have" on the grocery list adds it to the inventory (amount 0) so you can fill in how much you have. Sort by last update or name; saving an item into an existing ingredient/unit merges the amounts.
