...
TEXTS: dict[str, str] = {
    ...
    # nav
    "nav.week_menu": "🗓️ Weekmenu",
    "nav.grocery_list": "🛒 Boodschappen",
    "nav.recipes": "🍽️ Recepten",
    ...
    "nav.missing_tags": "🏷️ Zonder tags",
    "nav.settings": "⚙️ Opties",
    "nav.tag_groups": "🏷️ Tags beheren",
    "nav.shops": "🏪 Winkels",
    ...
    "recipe.edit.action.edit_title": "✏️ Wijzig titel",
    ...
    "recipe.edit.action.edit_description": "✏️ Bereiding wijzigen",
    ...
    "recipe.view.action.edit": "✏️ Recept wijzigen",
