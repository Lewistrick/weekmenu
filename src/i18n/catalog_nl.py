...
TEXTS: dict[str, str] = {
    ...
    "ingredient_units.aria.factor": "Conversiefactor",
    "ingredient_units.form.keep_unit": "Deze eenheid overal behouden",
    "ingredient_units.form.conversion": "Conversie",
    "ingredient_units.form.conversion_hint": "Voorbeeld: als je stuks behoudt, vul in hoeveel gram één stuk is (1 stuk = 200 gram).",
    ...
    "message.ingredient_units.invalid_factor": "Voer een positieve conversiefactor in.",
    "message.ingredient_units.nothing_to_convert": "Niets gebruikt de geselecteerde eenheid meer.",
    "message.ingredient_units.converted": "{count} regel(s) omgezet naar de geselecteerde eenheid.",
